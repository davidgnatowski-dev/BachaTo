...
const ONE_OFF_EVENTS: ScrapedEvent[] = [
  ...
  {
    externalId: "xplosion-ritmo-berlin-bswc-qualifier-2027",
    category: "competition",
    ...
    description:
      "Piąta edycja dużego konkursu bachaty social podczas Xplosion Ritmo Berlin. To oficjalne niemieckie eliminacje do finału Bachata Social World Cup 2027 w Genewie. Rejestracja jest indywidualna, a tancerze występują z losowanymi i zmienianymi partnerami. Eliminacje obejmują dwie grupy, następnie półfinał i finał z udziałem sędziów jako partnerów. Jury ocenia prowadzenie lub podążanie, kontakt w parze, muzykalność, umiejętność dopasowania się do różnych partnerów oraz technikę i jakość ruchu. Zwycięski Leader i zwycięski Follower otrzymają awans do światowego finału. Aby wystartować, trzeba mieć Full Pass albo Party Pass festiwalu; pojedynczy bilet na imprezę lub bilet dzienny nie wystarcza. Zapisy mają ruszyć w listopadzie 2026 roku, a opłata dla pierwszych 40 uczestników wynosi 25 euro.",
    competitionSeries: "Bachata Social World Cup 2026/2027",
    competitionStage: "qualifier",
    qualifiesFor: "Finał Bachata Social World Cup 2027 w Genewie",
    registrationStatus: "pending",
    registrationPrice: "25 EUR dla pierwszych 40 osób",
    qualifyingSpotsLeaders: 1,
    qualifyingSpotsFollowers: 1,
    startDate: "2027-05-13",
    endDate: "2027-05-17",
    sourceUrl: "https://xplosionevent.com/social-competition/",
  },
  {
